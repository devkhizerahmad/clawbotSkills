...
const READ_ONLY_COMMANDS = new Set([
  ...
  "getFormat",
  "revisions",
  "generate_rent_reconciliation_report",
]);
...
const HELP_TEXT = `
  ...
  Core data commands:
    ...
    generate_rent_reconciliation_report [spreadsheetId] [range] [outputPath] [--email=<email>] [--date=YYYY-MM-DD]
    get_rent_reconciliation_report <month> [unpaid|missing]
    get_unpaid_rent_report <month>
