 ...
 */
export const generateAgreementPdf = async (data, includeLetterhead) => {
  ...
  if (includeLetterhead) {
    ...
    if (typeof window === 'undefined') {
      ...
      // In Node, we can't easily get dimensions without a library,
      // so we use a reasonable aspect ratio or just set width
    } else {
      // Browser environment
      const img = new Image();
      img.src = hiveLogo;
